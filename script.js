// prep document for on load
$(document).ready(function () {
  // add eventListener to listen for a click in the search buton
  $("#search-button").on("click", function () {
    // store the search value in a variable, .val makes sure we are pulling the value of it in non string format
    var searchValue = $("#search-value").val();

    // clear input box
    $("#search-value").val("");
    // call the searchWeather function and pass it the searcValue
    searchWeather(searchValue);
  });
  // select the class "history" and add an event on click
